...
public class TransactionServiceImpl implements TransactionOfCustomerService {
    ...
    public TransactionOfCustomer create(TransactionOfCustomerRequest request){
        log.info("Inside create of TransactionOfCustomer Service ");
        TransactionOfCustomer transaction = transactionOfCustomerMapper.mapToTransactionRequest(request) ;
